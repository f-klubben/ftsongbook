...
#sang("Veteranens nostalgiske sang", subtext: "FVJ (Finn Verner Jensen) - Mel: I den gamle pavillon", cols: 2)[
  #note[Gammel version fundet i et en skift af FVT]

  #vers[
    Jeg er cand.scient. fra Aalborg UC  \
    og jeg ska' nu til  \
    at prøv' at brug' det.  \
    Ved Brønderslev er jeg blevet landsat  \
    og måske ansat  \
    i Harboør'.  \
